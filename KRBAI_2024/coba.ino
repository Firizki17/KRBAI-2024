...
//  * using pressure sensor MS5803 14B, IMU CMPS12 and BNO055
//  * ali@mdp.ac.id
//  * 
//  * update Program 21 Juni 2024
//  * IDE : Arduino 1.8.5
...
//   pinMode(6, OUTPUT); digitalWrite(6,HIGH);//SOS
//   pinMode(8, OUTPUT); digitalWrite(8,HIGH);//Lampu
...
//   boolean statusMisiAwal=true;//status menyelesaikan misi dari awal sampai sebelum drum
//   while (statusMisiAwal){
//     main_sensor(bno055);
...
//       else if(kamera == 'F' && objek == 5){
//         drum=true; //drum sudah ada di depan

//       } 
//       else {//tidak terpenuhi kondisi apapun, berarti vision blind
//         if (drum) statusMisiAwal=false;//keluar dari misi awal
//       }
...
//   }//tutup while untuk misi awal sebelum drum


//   //mempersiapkan diri untuk mencari posisi drum dengan tenggelam lebih dalam
//   set_level = 45;//tolong dimasukkan supaya level menjadi lebih dalam


//   //misi tracking drum
//   boolean statusMisiDrum=true;
//   boolean statusDrumInframe=false;//drum belum ada di frame

//   while (statusMisiDrum) {
//     main_sensor(bno055);
//     PID_pitch(pitch_kp, pitch_ki, pitch_kd, Pitch);
//     PID_Depth(depth_kp, depth_ki, depth_kd, avg);
//     PID_Heading(head_kp, head_ki, head_kd, Yaw);
...
//       }
//       else if (Yaw<gap_atas && Yaw>gap_bawah){
//         //posisi wahana boleh bekerja
//         if(kamera == 'F' && objek == 5 && width > 200 ){//jika ukuran objek drum yang dideteksi kamera depan sesuai
//           Serial2.println("objek drum");
//           statusDrumInFrame=true;
//     //      last_mission = true;
...
//         if (!statusDrumInFrame) {//jika drum belum pernah terdeteksi dengan ukuran lebih dari 200
//           //jika kondisi blind maka geser kanan
//           do{
//             main_sensor(bno055);
//             pitch_depth_head();
//             geserkanan_head();
...
//             set_level = -10;
//             finish = true;
//             statusMisiDrum = false;//keluar dari while statusMisiDrum
//           }
//         }

//       }//tutup bagian boleh bekerja
//     }//tutup head status

//   }//tutup statusMisiDrum
